...
if (!packageJson.private) throw new Error('The application package must stay private; AstroGuide is distributed as an app/container, not through npm.');
...
console.log(`AstroGuide version contract verified: ${version}`);
