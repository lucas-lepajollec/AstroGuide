...
- Use the established port `2502` both on the Docker host and inside the container, and reduce the default Compose file to the settings required to run the image.
